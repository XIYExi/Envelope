(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [4182, 4818],
  {
    84182: function (e, n, t) {
      ...
      n['default'] = () =>
        o().createElement(r.default, (0, a.Z)({ isTpl: !1 }, i));
    },
            ...
            (t.render = function () {
              ...
              return p.kK(a)
                ? o().createElement(
                    ...
                    (!(0, A.Z)(G) || !(0, A.Z)(c) || !(0, A.Z)(F)) &&
                      o().createElement(
                        h,
                        null,
                        Q.create(G, { autoGenerateKey: !1 }),
                        k.create(F, { autoGenerateKey: !1 }),
                        (0, I.BU)(c, { autoGenerateKey: !1 }),
                      ),
                  )
                : o().createElement(S, (0, l.Z)({}, R, { className: b }), X, a);
            }),
            n
          );
        })(s.Component);
      ...
      var K = t(49282),
        ...
        v = (e) => {
          ...
          return o().createElement(
            o().Fragment,
            null,
            n && o().createElement(K.Z, { src: i(), alt: 'Message' }),
            !n &&
              o().createElement(
                'div',
                null,
                o().createElement(
                  ...
                  o().createElement(F.Content, null, r),
                ),
              ),
          );
        },
