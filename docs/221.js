(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [221, 2462],
  {
    40221: function (A, e, t) {
      ...
      e['default'] = () =>
        g().createElement(I.default, (0, n.Z)({ isTpl: !1 }, B));
    },
    12462: function (A, e, t) {
      'use strict';
      t.r(e),
        t.d(e, {
          default: function () {
      ...
      function l(A) {
        ...
        return g().createElement(
          r,
          (0, Q.Z)({}, G, { className: a, 'data-text': I }),
          o.kK(t) ? C : t,
        );
      }
      (l.handledProps = [
      ...
      var a = l,
        ...
        J = (A) => {
          var e = A.isTpl,
            ...
            Q = t.test,
            s = t.unit,
            U = void 0 === s ? 'medium rectangle' : s;
          return g().createElement(
            g().Fragment,
            null,
            e && g().createElement(G.Z, { src: B(), alt: 'Advertisement' }),
            !e &&
              g().createElement(
                'div',
                null,
                g().createElement(
                  a,
                  { unit: U, centered: C, test: Q },
                  0 !== I.length &&
                    g().createElement('img', { src: I, alt: '' }),
                ),
              ),
          );
        },
