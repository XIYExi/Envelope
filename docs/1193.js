      ...
      var I = (function (e) {
        ...
        function n(e) {
          ...
          return (
            E(this, n),
            (r = t.call(this, e)),
            W(A(r), 'onDragStart', function (e, t) {
              (0, d.default)('Draggable: onDragStart: %j', t);
              var n = r.props.onStart(e, (0, s.createDraggableData)(A(r), t));
              if (!1 === n) return !1;
              r.setState({ dragging: !0, dragged: !0 });
            }),
            W(A(r), 'onDrag', function (e, t) {
              if (!r.state.dragging) return !1;
              (0, d.default)('Draggable: onDrag: %j', t);
              var n = (0, s.createDraggableData)(A(r), t),
                o = { x: n.x, y: n.y };
              if (r.props.bounds) {
                var a = o.x,
                  i = o.y;
                (o.x += r.state.slackX), (o.y += r.state.slackY);
                var u = (0, s.getBoundPosition)(A(r), o.x, o.y),
                  l = O(u, 2),
                  c = l[0],
                  f = l[1];
                (o.x = c),
            ...
            W(A(r), 'onDragStop', function (e, t) {
              if (!r.state.dragging) return !1;
              var n = r.props.onStop(e, (0, s.createDraggableData)(A(r), t));
              if (!1 === n) return !1;
            ...
            return (
                ...
                if (
                  ...
                  if (null != a) {
                    ...
                    !1 !== d &&
                      ...
                      (0, u.addEvent)(r, k.move, e.handleDrag),
                      (0, u.addEvent)(r, k.stop, e.handleDragStop));
                  }
                }
              }),
              C(M(e), 'handleDrag', function (t) {
                ...
                if (null != n) {
                  ...
                  var f = (0, l.createCoreData)(M(e), r, o);
              ...
              C(M(e), 'handleDragStop', function (t) {
                if (e.state.dragging) {
                  ...
                  if (null != n) {
                    ...
                    var d = (0, l.createCoreData)(M(e), r, o),
