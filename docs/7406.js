(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [7406, 7787],
  {
    77406: function (e, A, t) {
      ...
      A['default'] = () =>
        C().createElement(g.default, (0, l.Z)({ isTpl: !1 }, n));
    },
    67787: function (e, A, t) {
      'use strict';
      t.r(A);
      var l = t(57337),
        s = t(93224),
        ...
        switch (A.type) {
          ...
          case 'START_SEARCH':
            return (0, C.Z)(
              (0, C.Z)({}, e),
              {},
              { loading: !0, value: A.query },
            );
          case 'FINISH_SEARCH':
            return (0, C.Z)(
              (0, C.Z)({}, e),
              {},
              { loading: !1, results: A.results },
            );
          case 'UPDATE_SELECTION':
            return (0, C.Z)((0, C.Z)({}, e), {}, { value: A.selection });
          default:
            throw new Error();
        }
      }
        ...
        var A = e.isTpl,
          ...
          J = n().useCallback((e, A) => {
            clearTimeout(h.current),
              c({ type: 'START_SEARCH', query: A.value }),
              (h.current = setTimeout(() => {
                if (0 !== A.value.length) {
                  var e = new RegExp(r().escapeRegExp(A.value), 'i'),
                    t = (A) => e.test(A.title);
                  c({ type: 'FINISH_SEARCH', results: r().filter(C, t) });
                } else c({ type: 'CLEAN_QUERY' });
              }, 300));
          }, []);
        return (
          n().useEffect(
          ...
          n().createElement(
            n().Fragment,
            null,
            A && n().createElement(o.Z, { src: a(), alt: 'Search' }),
            !A &&
              n().createElement(
                'div',
                null,
                n().createElement(u.Z, {
                  ...
                  placeholder: g,
                  onResultSelect: (A, t) => {
                    c({ type: 'UPDATE_SELECTION', selection: t.result.title }),
                      e.onResultSelect && e.onResultSelect(t.result);
                  },
                  onSearchChange: J,
                  results: G,
                  value: R,
