(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [7406],
  {
    ...
    37406: function (e, t, n) {
      ...
      (en.handledProps = ['categoryContent', 'resultsContent']),
        (en.propTypes = {});
      var tn = en;
      function nn(e) {
        var t = e.active,
          ...
          s = e.layoutRenderer,
          l = e.renderer,
          i = (0, Vt.default)((0, Lt.lG)(t, 'active'), 'category', r),
          u = (0, Wt.Z)(nn, e),
          c = (0, Jt.Z)(nn, e),
          p = l(e),
          h = $t.kK(n) ? o : n;
        ...
        return (
          (n.render = function () {
            var e = this.props,
              ...
              r = e.className,
              o = e.renderer,
              s = (0, Vt.default)((0, Lt.lG)(n, 'active'), 'result', r),
              l = (0, Wt.Z)(t, this.props),
              i = (0, Jt.Z)(t, this.props);
            return Ut().createElement(
              i,
      ...
      (sn.handledProps = [
        ...
        (sn.propTypes = {}),
        (sn.defaultProps = { renderer: an }),
        (ln.handledProps = ['as', 'children', 'className', 'content']),
        (ln.propTypes = {});
      var un = ln,
        cn = function (e) {
          var t = e.input;
            ...
            return (
              ...
              (t.handleMouseDown = function (e) {
                (t.isMouseDown = !0),
                  ...
                  zt.Z.sub('mouseup', t.handleDocumentMouseUp);
              }),
              (t.handleDocumentMouseUp = function () {
                (t.isMouseDown = !1),
                  zt.Z.unsub('mouseup', t.handleDocumentMouseUp);
              }),
              ...
              (t.renderCategories = function () {
                ...
                return (0, bt.Z)(s, function (e) {
                  ...
                  return (
                    (i += u.results.length),
                    Ut().createElement(rn, c, u.results.map(p))
                  );
                });
              }),
              ...
              (t.renderResultsMenu = function () {
                ...
                if (r) return Ut().createElement(un, { className: n }, r);
              }),
              t
            );
          }
          ...
          return (
            ...
            (n.componentDidUpdate = function (e, t) {
              !t.focus && this.state.focus
                ...
                !t.open && this.state.open
                  ? (this.open(),
                    zt.Z.sub('click', this.closeOnDocumentClick),
                    zt.Z.sub('keydown', [
                      this.closeOnEscape,
                      this.moveSelectionOnKeyDown,
                      this.selectItemOnEnter,
                  ...
                  : t.open &&
                    !this.state.open &&
                    (this.close(),
                    zt.Z.unsub('click', this.closeOnDocumentClick),
                    zt.Z.unsub('keydown', [
                      this.closeOnEscape,
                      this.moveSelectionOnKeyDown,
                      this.selectItemOnEnter,
            ...
            (n.render = function () {
              var e = this.state,
                ...
                v = (0, Wt.Z)(t, this.props),
                f = (0, Jt.Z)(t, this.props),
                m = (0, Qt.vR)(v, { htmlProps: Qt._l }),
                g = m[0],
                y = m[1];
              return Ut().createElement(
                f,
      ...
      (pn.handledProps = [
        ...
        (pn.autoControlledProps = ['open', 'value']),
        (pn.Category = rn),
        (pn.Result = sn),
        (pn.Results = un);
    },
