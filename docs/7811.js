  ...
  [7811],
  {
    ...
    77811: function (e, n, t) {
      ...
      var o = t(22122),
              ...
              },
              {
                ...
                value: function () {
                  var e = this.props,
                    ...
                    l = 'undefined' === typeof n ? (c || '').toString() : n,
        ...
        M = { success: s.Z, info: g.Z, error: l.Z, warning: m.Z },
        S = { success: r.Z, info: u.Z, error: A.Z, warning: C.Z },
        Z = function (e) {
          var n = e.description,
            t = e.icon,
            o = e.prefixCls,
            ...
            ? (0, d.wm)(
                ...
                function () {
                  return {
                    className: p()(
                      ''.concat(o, '-icon'),
                      (0, c.Z)({}, t.props.className, t.props.className),
                    ),
                  };
                },
              )
            : B.createElement(s, { className: ''.concat(o, '-icon') });
        },
        w = function (e) {
          var n = e.isClosable,
            t = e.closeText,
        ...
        v = function (e) {
          var n,
            ...
            h = e.closeText,
            J = e.closeIcon,
            b = void 0 === J ? B.createElement(i.Z, null) : J,
            k = e.action,
            F = y(e, [
              'description',
              'prefixCls',
            ...
            x = function (e) {
              var n;
              N(!0), null === (n = F.onClose) || void 0 === n || n.call(F, e);
            },
            L = function () {
              var e = F.type;
            ...
            Y = p()(
              ...
              ''.concat(q, '-').concat(j),
              ((n = {}),
              (0, c.Z)(n, ''.concat(q, '-with-description'), !!t),
              (0, c.Z)(n, ''.concat(q, '-no-icon'), !T),
              (0, c.Z)(n, ''.concat(q, '-banner'), !!l),
              (0, c.Z)(n, ''.concat(q, '-rtl'), 'rtl' === D),
              n),
              m,
            ),
            O = (0, U.Z)(F);
