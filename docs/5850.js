(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [5850, 5559],
  {
    55850: function (e, A, t) {
      ...
      A['default'] = () =>
        g().createElement(C.default, (0, I.Z)({ isTpl: !1 }, o));
    },
    45559: function (e, A, t) {
      'use strict';
      t.r(A);
      var I = t(57337),
        n = t(93224),
        ...
        E = (e) => {
          var A = e.isTpl,
            ...
            k = (A, t) => {
              var I = t.activePage;
              h(I), e.onPageChange && e.onPageChange(I);
            };
          return C().createElement(
            C().Fragment,
            null,
            A && C().createElement(l.Z, { src: a(), alt: 'Pagination' }),
            !A &&
              C().createElement(
                'div',
                null,
                C().createElement(m.Z, {
                  onPageChange: (e, A) => k(e, A),
                  disabled: E,
                  totalPages: s,
                  defaultActivePage: u,
                  ellipsisItem: {
                    content: C().createElement(B.Z, { name: c }),
                    icon: !0,
                  },
                  firstItem: {
                    content: C().createElement(B.Z, { name: U }),
                    icon: !0,
                  },
                  lastItem: {
                    content: C().createElement(B.Z, { name: i }),
                    icon: !0,
                  },
                  prevItem: {
                    content: C().createElement(B.Z, { name: G }),
                    icon: !0,
                  },
                  nextItem: {
                    content: C().createElement(B.Z, { name: J }),
                    icon: !0,
                  },
                }),
              ),
