      ...
      var t = n(93224),
        ...
        i = (e) => {
          ...
          return l().createElement(
            l().Fragment,
            null,
            A && l().createElement(g.Z, { src: r(), alt: 'Header' }),
            !A &&
              l().createElement(
                'div',
                null,
    ...
    39445: function (e, A, n) {
      ...
      function E(e) {
        var A = e.attached,
          ...
          S = (0, s.Z)(E, e);
        if (!C.kK(l))
          return o().createElement(S, (0, t.Z)({}, f, { className: M }), l);
        var X = i.Z.create(h, { autoGenerateKey: !1 }),
          Z = I.Z.create(b, { autoGenerateKey: !1 }),
        ...
        return X || Z
          ? o().createElement(
              ...
              (0, t.Z)({}, f, { className: M }),
              X || Z,
              (m || D) && o().createElement(Q, null, m, D),
            )
          : o().createElement(S, (0, t.Z)({}, f, { className: M }), m, D);
      }
      (E.handledProps = [
        'as',
        'attached',
