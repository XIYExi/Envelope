    ...
    12462: function (A, e, C) {
      ...
      function G(A) {
        ...
        return g().createElement(
          F,
          (0, Q.Z)({}, J, { className: l, 'data-text': n }),
          s.kK(C) ? I : C,
        );
      }
      (G.handledProps = [
      ...
      var l = G,
        ...
        a = (A) => {
          var e = A.isTpl,
            ...
            Q = C.test,
            U = C.unit,
            E = void 0 === U ? 'medium rectangle' : U;
          return g().createElement(
            g().Fragment,
            null,
            e && g().createElement(J.Z, { src: B(), alt: 'Advertisement' }),
            !e &&
              g().createElement(
                'div',
                null,
                g().createElement(
                  l,
                  { unit: E, centered: I, test: Q },
                  0 !== n.length &&
                    g().createElement('img', { src: n, alt: '' }),
                ),
              ),
          );
        },
