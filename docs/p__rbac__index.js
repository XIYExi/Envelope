  ...
  [4135],
  {
    86719: function (e, t, l) {
      ...
      var r = l(55672),
        ...
        Q = (0, d.connect)((e) => ({ cstate: e.present.rbacModal }))(I),
        X = (l(60674), l(20995)),
        G = l.n(X),
        P = A.Z.Header,
        w = A.Z.Content,
                ...
                'server' === h.m8.location.pathname.split('/').slice(-1)[0]
                  ...
                  : c().createElement(
                      ...
                      c().createElement(
                        r.Z.Text,
                        null,
                        '2023.09.23 Ink Platform Copyright\xa9',
                      ),
                    ),
              ),
            ),
    ...
    48091: function (e, t, l) {
      ...
      var r = 'http://localhost:8000/api',
        n = 'http://localhost:8000/rbac',
        a = 'http://localhost:8000/templateApi';
    },
    20995: function (e) {
      e.exports =
