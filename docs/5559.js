      ...
      var n = I(2824),
        ...
        U = (A) => {
          var e = A.isTpl,
            ...
            K = (e, I) => {
              var n = I.activePage;
              h(n), A.onPageChange && A.onPageChange(n);
            };
          return C().createElement(
            C().Fragment,
            null,
            e && C().createElement(m.Z, { src: o(), alt: 'Pagination' }),
            !e &&
              C().createElement(
                'div',
                null,
                C().createElement(Q.Z, {
                  onPageChange: (A, e) => K(A, e),
                  disabled: U,
                  totalPages: l,
                  defaultActivePage: M,
                  ellipsisItem: {
                    content: C().createElement(a.Z, { name: i }),
                    icon: !0,
                  },
                  firstItem: {
                    content: C().createElement(a.Z, { name: G }),
                    icon: !0,
                  },
                  lastItem: {
                    content: C().createElement(a.Z, { name: s }),
                    icon: !0,
                  },
                  prevItem: {
                    content: C().createElement(a.Z, { name: J }),
                    icon: !0,
                  },
                  nextItem: {
                    content: C().createElement(a.Z, { name: F }),
                    icon: !0,
                  },
                }),
              ),
