(self['webpackChunkenvelope'] = self['webpackChunkenvelope'] || []).push([
  [5679, 4304],
  {
    35679: function (e, t, n) {
      ...
      t['default'] = () =>
        l().createElement(o.default, (0, A.Z)({ isTpl: !1 }, r));
    },
      ...
      var A = n(93224),
        ...
        d = (e) => {
          ...
          return l().createElement(
            l().Fragment,
            null,
            t && l().createElement(i.Z, { src: r(), alt: 'Header' }),
            !t &&
              l().createElement(
                'div',
                null,
                l().createElement(
                  ...
                  l().createElement(s.Z.Content, null, a),
                  0 !== B.length && l().createElement(s.Z.Subheader, null, B),
                ),
              ),
          );
        };
    ...
    39445: function (e, t, n) {
      ...
      function Q(e) {
        var t = e.attached,
          ...
          Z = (0, s.Z)(Q, e);
        if (!g.kK(l))
          return o().createElement(Z, (0, A.Z)({}, M, { className: K }), l);
        var S = d.Z.create(b, { autoGenerateKey: !1 }),
          X = C.Z.create(h, { autoGenerateKey: !1 }),
          D = B.create(p, { autoGenerateKey: !1 });
        return S || X
          ? o().createElement(
              Z,
              (0, A.Z)({}, M, { className: K }),
              S || X,
              (m || D) && o().createElement(u, null, m, D),
            )
          : o().createElement(Z, (0, A.Z)({}, M, { className: K }), m, D);
      }
      (Q.handledProps = [
        'as',
        'attached',
