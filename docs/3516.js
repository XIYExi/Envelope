    ...
    13516: function (A, e, a) {
      ...
      function w(A, e, a) {
        void 0 === e && (e = {}),
          ...
          a.forEach((a) => {
            var t = 'enable' + a,
              o = e[t] ? 'enable' + a : 'disable' + a;
            A && void 0 !== e[t] && A[o] && A[o]();
          });
      }
      function g(A, e) {
        void 0 === e && (e = {});
        ...
        (0, r.useEffect)(() => {
          A &&
            void 0 !== a &&
            (a ? A.show && A.show() : A.hide && A.hide(), a !== t && o(a));
        }, [A, t, a]);
      }
      function B(A, e, a) {
        void 0 === a && (a = []),
          a.forEach((a) => {
            var t = '' + a.charAt(0).toLowerCase() + a.slice(1),
              [o, n] = (0, r.useState)(e[t]);
            (0, r.useEffect)(() => {
              if (A && A['set' + a] && void 0 !== e[t]) {
                var r = e[t];
                if (r && r.lng && r.lat) {
                  r = new BMap.Point(r.lng, r.lat);
                  var s = o;
                  if (
                    s &&
                    s.lng &&
                    s.lat &&
                    ((s = new BMap.Point(s.lng, s.lat)), r.equals(s))
                  )
                    return;
                }
                A['set' + a](r),
        ...
        return new Promise((a, t) => {
          if (document && !(A in C)) {
            ...
            (o.type = 'text/javascript'),
              (o.id = '_react_baidu_map'),
              (o.src = A),
              (o.async = !0),
              (o.defer = !0),
              (o.onerror = (a) => {
                e.removeChild(o),
                  t(new URIError('The Script ' + A + ' is no accessible.'));
              }),
              (o.onload = () => {
                (C[A] = !0), a();
              }),
      ...
      var D = () => {
          var [A] = n().useState(() => {
            ...
            t = n().useCallback((A) => {
              var e = (e) => {
                  var { children: a } = e;
                  return a ? (0, o.createPortal)(a, A) : null;
                },
                a = (A) => {
                  A && (0, o.unmountComponentAtNode)(A);
                };
              return { render: e, remove: a };
            }, []);
          return (
            (0, r.useEffect)(() => {
              A && e.remove();
            ...
            { Portal: e.render, container: A }
          );
        },
        l = a(92137);
      function V(A) {
        return new Promise((e, a) => {
          window && window.setTimeout(e, A);
        });
      }
      var f = 3;
      class q extends n().Component {
        static ready() {
          return (0, l.Z)(function* () {
            if (
              (!window || !window.BMap.Map) &&
              (!window || !window.BMapGL.Map)
            )
              return new Promise((A, e) => {
                q.waitQueue.push([A, e]);
              });
          })();
        }
        constructor(A) {
          if (
            ...
            (this.isMountedOk = !1),
            (this.handleError = (A) => {
              this.isMountedOk && this.setState({ error: A });
            }),
            (this.finish = () => {
              window &&
                'webgl' === this.props.type &&
                (window.BMap = window.BMapGL),
                this.isMountedOk && this.setState({ loaded: !0 });
            }),
            (this.state = {
              loaded:
                'webgl' === A.type
            ...
            null == this.props.akay)
          )
            throw new TypeError('BaiDuMap: akay is required');
        }
        componentDidMount() {
          this.isMountedOk = !0;
          var { callbackName: A } = this.props;
          if (
            window &&
            A &&
            (('webgl' === this.props.type &&
              ...
              window.BMapGL &&
              !window.BMapGL.Map) ||
              ('webgl' === this.props.type && window && !window.BMapGL) ||
              (window && window.BMap && !window.BMap.Map) ||
              (window && !window.BMap))
          ) {
            if (window && window[A])
              return void q.waitQueue.push([this.finish, this.handleError]);
            this.loadMap();
          }
        }
        ...
        getScriptSrc() {
          var A = this.props,
            e = A.protocol || window.location.protocol;
          -1 === e.indexOf(':') && (e += ':');
          var a = [
            'v=' + A.version,
            'ak=' + A.akay,
            'callback=' + A.callbackName,
          ];
          return (
            A.type && a.push('type=' + A.type),
            e + '//' + A.hostAndPath + '?' + a.join('&')
          );
        }
        loadMap() {
          var A = this;
          return (0, l.Z)(function* () {
            var { callbackName: e } = A.props;
            if (window && e) {
              var a = A.getScriptSrc();
              window[e] = () => {
                var e = q.waitQueue;
                (q.waitQueue = []), e.forEach((A) => A[0]()), A.finish();
              };
              for (var t = 0; t < f; t++)
                try {
                  yield i(a);
                  ...
                  if (t === f - 1) {
                    var o = (function () {
                      var e = new Error(
                          'Failed to load Baidu Map: ' + r.message,
                        ),
                        a = q.waitQueue;
                      return (
                        (q.waitQueue = []),
      ...
      var v = a(22122),
        O = a(19756),
        W = { map: void 0, BMap: void 0, container: void 0 },
        Q = (A, e) => (0, v.Z)({}, A, e),
        Y = n().createContext({ state: W, dispatch: () => null });
      function P() {
        var { state: A, dispatch: e } = (0, r.useContext)(Y);
        return (0, v.Z)({}, A, { state: A, dispatch: e });
      }
      function L(A) {
        void 0 === A && (A = {});
        var {
            ...
            maxZoom: t,
            mapType: o,
            enableHighResolution: n,
            enableAutoResize: s,
            enableMapClick: g,
          } = A,
          [p, C] = (0, r.useState)(),
          [i, D] = (0, r.useState)(A.zoom || 15),
          [l, V] = (0, r.useState)(A.container),
          { dispatch: f } = (0, r.useContext)(Y);
        (0, r.useMemo)(() => {
          if (l && !p && BMap) {
            var A = new BMap.Map(l, {
              minZoom: a,
              maxZoom: t,
              mapType: o,
              enableHighResolution: n,
            ...
            e &&
              e.forEach((e) => {
                if (BMap)
                  if ('string' === typeof e) {
                    var a = BMap[e];
                    a && A.addControl(new a());
                  } else if (
                    'object' === typeof e &&
                    e.control &&
                    'function' === typeof e.control
                  )
                    A.addControl(e.control(BMap, A));
                  else if ('object' === typeof e && e.name) {
                    var t =
                        'function' === typeof e.options
                          ? e.options(BMap, A)
                          : e.options,
                      o = BMap[e.name];
                    o && A.addControl(new o(t));
                  }
              }),
              C(A);
          }
          ...
          (0, r.useEffect)(
            () => (
              p && l && f({ map: p, container: l, BMap: BMap }),
              () => {
                f({ map: void 0, container: void 0, BMap: void 0 });
              }
            ),
            [p, l],
          );
        var [q, v] = (0, r.useState)(A.center || '\u4e0a\u6d77');
        (0, r.useEffect)(() => {
          if (p && q) {
            var A = q;
            q &&
              q.lng &&
              q.lat &&
              ((A = new BMap.Point(q.lng, q.lat)), p.centerAndZoom(A, i)),
              p.centerAndZoom(q, i);
          }
        }, [q, p]);
        var [O, W] = (0, r.useState)(A.autoLocalCity);
        return (
          (0, r.useEffect)(() => {
            if (p && O) {
              var A = new BMap.LocalCity();
              A.get((A) => {
                v(A.name), D(A.level), W(!1);
              });
            }
          }, [O, p]),
          d(p, A, [
      ...
      var H = ['className', 'style', 'children'],
        U = n().forwardRef((A, e) => {
          var { className: a, style: t, children: o } = A,
            w = (0, O.Z)(A, H),
            [g, B] = (0, r.useReducer)(Q, W);
          ...
          var d = (0, r.useRef)(null),
            {
              ...
              setAutoLocalCity: D,
              map: l,
            } = L((0, v.Z)({ container: d.current }, w));
          (0, r.useEffect)(() => p(d.current), [d.current]),
            (0, r.useMemo)(() => w.center && i(w.center), [w.center]),
            (0, r.useEffect)(() => D(w.autoLocalCity), [w.autoLocalCity]),
            (0, r.useImperativeHandle)(
              e,
              () =>
                (0, v.Z)({}, w, { map: l, BMap: BMap, container: d.current }),
              [l],
            );
          var V = n().Children.toArray(o);
          return (
            (0, r.useEffect)(() => {
              l && B({ map: l, container: d.current, BMap: BMap });
            }, [l]),
            (0, s.jsxs)(Y.Provider, {
              value: { state: g, dispatch: B },
              children: [
                (0, s.jsx)('div', {
                  ref: d,
                  className: a,
                  style: (0, v.Z)({ fontSize: 1, height: '100%' }, t),
                }),
                BMap &&
                  l &&
                  'function' === typeof o &&
                  o({ BMap: BMap, map: l, container: C }),
                BMap &&
                  l &&
                  V.map((A, e) =>
                    n().isValidElement(A)
                      ? A.type && 'string' === typeof A.type
                        ? n().cloneElement(A, { key: e })
                        : n().cloneElement(
                            A,
                            (0, v.Z)({}, A.props, {
                              BMap: BMap,
      ...
      var F =
        ...
        u = (A) => {
          for (
            ...
            e['red' + a] = new BMap.Icon(F, new BMap.Size(21, 33), {
              imageOffset: new BMap.Size(0 - 21 * (a - 1), 0),
              anchor: new BMap.Size(10.5, 33),
            });
          for (var t = 1; t <= 10; t++)
            e['blue' + t] = new BMap.Icon(F, new BMap.Size(21, 33), {
              imageOffset: new BMap.Size(0 - 21 * (t - 1), -66),
              anchor: new BMap.Size(10.5, 33),
            });
          return e[A];
        };
      function h(A) {
        ...
        (0, r.useEffect)(() => {
          ...
          var A = {
            ...
            r = new BMap.Point(e.lng, e.lat),
            w = new BMap.Marker(r, A);
          return (
            q.addOverlay(w),
            w.setAnimation(a),
            O(w),
        ...
        var [W, Q] = (0, r.useState)(A.type || 'loc_blue');
        return (
          (0, r.useEffect)(() => {
            if (q && v && !n && W) {
              var A = u(W);
              console.log('>>>>newIcon>>>', A),
                A.setImageSize(new BMap.Size(300, 300)),
                v.setIcon(A);
            }
          }, [W, v]),
          g(v, A),
          ...
          w(v, A, ['Dragging', 'MassClear', 'Clicking']),
          B(v, A, [
            'Icon',
            'Position',
            'Animation',
          ...
          { marker: v, setMarker: O, type: W, setType: Q }
        );
      }
      var E = n().forwardRef((A, e) => {
        var { marker: a, setType: t } = h(A);
        return (
          (0, r.useEffect)(() => A.type && t(A.type), [A.type]),
          (0, r.useImperativeHandle)(e, () => (0, v.Z)({}, A, { marker: a })),
          null
        );
      });
      function y(A) {
        void 0 === A && (A = {});
        var [e, a] = (0, r.useState)(),
          {
            offset: t,
            style: o,
            content: n = '',
          ...
          { container: C, Portal: i } = D(),
          { map: l } = P();
        return (
          (0, r.useEffect)(() => {
            if (BMap && l) {
              if (!e) {
                var r = { offset: t, position: s, enableMassClear: p },
                  w = new BMap.Label(A.children ? C.innerHTML : n, r);
                w.setStyle((0, v.Z)({}, o)), l.addOverlay(w), a(w);
              }
              return () => {
                l && e && l.removeOverlay(e);
              };
            }
          }, [l]),
          (0, r.useEffect)(() => {
            e && e.setContent(A.children ? C.innerHTML : n);
          }, [A.children, C, e]),
          g(e, A),
          d(e, A, [
            'Click',
          ...
          B(e, A, ['Style', 'Position', 'Offset', 'Title', 'ZIndex']),
          w(e, A, ['MassClear']),
          { label: e, setLabel: a, Portal: i }
        );
      }
      var c = n().forwardRef((A, e) => {
        var { label: a, Portal: t } = y((0, v.Z)({}, A));
        return (
          (0, r.useImperativeHandle)(e, () => (0, v.Z)({}, A, { label: a }), [
            a,
            A,
          ]),
          (0, s.jsx)(t, { children: A.children })
        );
      });
      function K(A) {
        void 0 === A && (A = {});
          ...
          (0, r.useEffect)(() => {
            if (n && !e) {
              var A = new BMap.CopyrightControl({
                anchor: t || BMAP_ANCHOR_TOP_RIGHT,
                offset: o,
              });
              n.addControl(A), a(A);
            }
            return () => {
              n && e && n.removeControl(e);
            };
          }, [n, e, t, o]),
          g(e, A),
          B(e, A, ['Anchor', 'Offset']),
          { copyrightControl: e, setCopyrightControl: a }
        );
      }
      var M = 1;
      function I(A) {
        void 0 === A && (A = {});
        var { children: e, control: a, bounds: t } = A,
          [o] = (0, r.useState)(M++),
          { container: n, Portal: w } = D(),
          g = p(o);
        return (
          (0, r.useEffect)(
            () => (
              a && a.addCopyright({ id: o, bounds: t, content: n.innerHTML }),
              function () {
                g && a && a.removeCopyright(g);
              }
            ),
            [t, e, n, a, o, g],
          ),
          (0, s.jsx)(w, { children: e })
        );
      }
      var N = n().forwardRef((A, e) => {
        var { copyrightControl: a } = K(A);
        return (
          (0, r.useImperativeHandle)(
            e,
            () => (0, v.Z)({}, A, { copyrightControl: a }),
            [a, A],
          ),
          (0, s.jsx)(r.Fragment, {
            children: n()
              ...
              .map((A, e) =>
                n().isValidElement(A)
                  ? n().cloneElement(A, { control: a, id: e + 1 })
                  : A,
              ),
          })
        );
