...
import { AntDesignOutlined, MobileOutlined, RightOutlined } from '@ant-design/icons';
        ...
        <div className='ui-sys-card'>
          {
            ui === 'antd' &&
              <React.Fragment>
                <Image preview={false} src={antd} alt='' width={300} height={350}/>
...

          {
            ui === 'semantic' &&
            <React.Fragment>
              <Image preview={false} src={sem} alt='' width={300} height={350}/>
              <Typography.Paragraph className='ui-sys-text'>
                Stacks is a production-ready library of stackable content blocks built in React Native
              </Typography.Paragraph>
            </React.Fragment>
...

          {
            ui === 'lole' &&
            <React.Fragment>
              <Image preview={false} src={lole} alt='' width={300} height={350}/>
              <Typography.Paragraph className='ui-sys-text'>
                Stacks is a production-ready library of stackable content blocks built in React Native
              </Typography.Paragraph>
            </React.Fragment>
