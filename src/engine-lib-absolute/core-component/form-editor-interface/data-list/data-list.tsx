...
import { TDataListDefaultType, TDataListDefaultTypeItem } from '../../type';
...
const DragActionBar = styled.div`
  position: absolute;
  right: 0;
  top: 50%;
...
const List:FC<DataListType> = (props) => {
  const {
    onChange,
    value,
    connectDropTarget,
...
const DataList:FC<DataListMemo> = (props) => {
  return(
