...
module.exports = {
  productName: 'Envelope', //项目名
  appId: 'envelope-platform',
  copyright: 'Copyright © Envelope', //版权
  extraMetadata: {
    // 注入打包后package.json的属性
    main: './index.js', // 修改包入口
  },
  directories: {
    output: 'release', // 输出文件夹
  },
  files: ['index.js', 'main/', 'dist/', 'node_modules/', 'package.json'], // 需要打包的文件
  // mac打包配置
  mac: {
